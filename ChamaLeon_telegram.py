...
CATEGORY_MAP = {
    ...
    "consulta":           ("Saúde", "expense"),
    "exame":              ("Saúde", "expense"),
    "hospital":           ("Saúde", "expense"),
    "clinica":            ("Saúde", "expense"),
    "clínica":            ("Saúde", "expense"),
    "dentista":           ("Saúde", "expense"),
    "psicologo":          ("Saúde", "expense"),
    "psicólogo":          ("Saúde", "expense"),
    "terapia":            ("Saúde", "expense"),
    "remedio":            ("Saúde", "expense"),
    "remédio":            ("Saúde", "expense"),
    "vitamina":           ("Saúde", "expense"),
    "plano de saude":     ("Saúde", "expense"),
    "plano de saúde":     ("Saúde", "expense"),
    ...
    "colegio":            ("Educação", "expense"),
    "colégio":            ("Educação", "expense"),
    "livro":              ("Educação", "expense"),
    "apostila":           ("Educação", "expense"),
    "material escolar":   ("Educação", "expense"),
    "certificacao":       ("Educação", "expense"),
    "certificação":       ("Educação", "expense"),
    "idioma":             ("Educação", "expense"),
    "ingles":             ("Educação", "expense"),
    "inglês":             ("Educação", "expense"),

    # Compras — expense
    "mercado":            ("Compras", "expense"),
    "supermercado":       ("Compras", "expense"),
    "atacadao":           ("Compras", "expense"),
    "atacadão":           ("Compras", "expense"),
    "compra":             ("Compras", "expense"),
    "shopping":           ("Compras", "expense"),
    "roupa":              ("Compras", "expense"),
    "calcado":            ("Compras", "expense"),
    "calçado":            ("Compras", "expense"),
    "tenis":              ("Compras", "expense"),
    "tênis":              ("Compras", "expense"),
    "presente":           ("Compras", "expense"),
    "eletronico":         ("Compras", "expense"),
    "eletrônico":         ("Compras", "expense"),
    "celular novo":       ("Compras", "expense"),
...
CATEGORIES = [
    ...
    "Saúde", "Educação", "Moradia", "Compras", "Trabalho", "Outros"
]
...
def normalize_keyword(text: str) -> str:
    """Normaliza texto para matching mais tolerante."""
...
def detect_category(text: str) -> Tuple[str, str]:
    ...
    for keyword, (category, trans_type) in CATEGORY_MAP.items():
        ...
        if (
            ...
            or normalized_keyword.replace(" ", "") in compact_text
        ):
